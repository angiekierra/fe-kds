    ...
    <div className="space-y-6">
      <div className="text-center p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
        ...
        <div className="text-lg text-gray-600 mb-3">
          Overall Regulatory Compatibility
        </div>
            ...
            return (
              <div key={i} className="p-3 border rounded-lg">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div
                    className={`font-medium ${getScoreColor(motif.compatibility_score)}`}
                  >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                  <div>
                    ...
                    <div>
                      Canonical position: {motif.canonical_position} bp from TSS
                    </div>
                  </div>
                  <div>
                    ...
                    <div
                      className={
                        motif.compatibility_score >= 0.8
                          ? "text-green-600"
                          : motif.compatibility_score >= 0.6
                            ? "text-yellow-600"
                            : "text-red-600"
                      }
                    >
                ...
                <Progress
                  value={motif.compatibility_score * 100}
                  className="mt-2"
                />
              </div>
            );
      ...
      <div className="p-4 bg-gray-50 rounded-lg">
        ...
        <ul className="text-sm space-y-1 text-gray-700">
          <li>
            • <strong>Position-aware scoring:</strong> Motifs closer to
            canonical positions score higher
          </li>
          <li>
            • <strong>Distance penalty:</strong> Score decreases with distance
            from optimal location
          </li>
          <li>
            • <strong>Functional relevance:</strong> Only biologically relevant
            positions contribute to regulation
          </li>
          <li>
            • <strong>TSS reference:</strong> All positions calculated relative
